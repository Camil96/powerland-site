jsFrontend.news={init:function(){jsFrontend.initPhotoSwipeFromDOM('.carousel-photoswipe')
jsFrontend.news.customPhotoSwipeFunctionality()},customPhotoSwipeFunctionality:function(){function initExternalPhotoSwipeThumbs(thumbSelector,gallerySelector){document.querySelectorAll(thumbSelector).forEach(function(thumb){thumb.addEventListener('click',function(e){e.preventDefault()
...
return items}}
initExternalPhotoSwipeThumbs('.article-detail-images img','.carousel-photoswipe')},}
